...
g++ src/sandbox/sandbox.cpp bin/lib/Quads.o bin/lib/Renderer.o bin/lib/DisplayManager.o bin/lib/glad.o -o bin/debug/sandbox.exe -Iinclude -Lbin/lib -lmingw32 -lglfw3 -lopengl32 -lgdi32 -luser32
